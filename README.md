...
# Below is [MOSTLY] info on installing the package manager elsewhere, not Splux itself. And for maintainers of Splux.
----------------------------
## Requirements
...
https://github.com/RobertFlexx/SPS/releases/tag/live-2026-09-04-1
...
```sh
# flash (example)
dd if=sps-live.iso of=/dev/sdX bs=4M status=progress conv=fsync
```
